...
% 20-20基于[18 24 31]位置
% vals = [0.27277     0.69474      0.5209]; % 0.0039+0.0043+1.4884=1.4966
% 再给EGWO增加循环次数可以运行到何种程度

%% PSO3综合优化结果 ob1 ob2 X
% vals = [0.3030 0.4149 0.8009]; % 0.0056+0.0067+1.5188=1.5311

% 20-20基于[18 24 31]位置
% vals = [0.28087     0.76478     0.45283]; % 0.0042+0.0018+1.4985=1.5045

%% GWO3综合优化结果 ob1 ob2 X
% vals = [0.2788 0.5478 0.6735]; % 0.0048+0.0027+1.5001=1.5076
% 20-20基于[18 24 31]位置
% vals = [0.2786 0.6516 0.5656]; % 0.0042+0.0019+1.4958=1.5018
