...
% mpc.bus = [ %% (Pd and Qd are specified in kW & kVAr here, converted to MW & MVAr below)
% 1	3	0 	0 	0	0	1	1	0	12.66	1	1	1;
% 2	1	43 	10 	0	0	1	1	0	12.66	1	1.1	0.9;
% 3	1	43 	7 	0	0	1	1	0	12.66	1	1.1	0.9;
% 4	1	57 	14 	0	0	1	1	0	12.66	1	1.1	0.9;
% 5	1	33 	5 	0	0	1	1	0	12.66	1	1.1	0.9;
% 6	1	27 	3 	0	0	1	1	0	12.66	1	1.1	0.9;
% 7	1	89 	17 	0	0	1	1	0	12.66	1	1.1	0.9;
% 8	1	93 	17 	0	0	1	1	0	12.66	1	1.1	0.9;
% 9	1	41 	3 	0	0	1	1	0	12.66	1	1.1	0.9;
% 10	1	42 	3 	0	0	1	1	0	12.66	1	1.1	0.9;
% 11	1	35 	5 	0	0	1	1	0	12.66	1	1.1	0.9;
% 12	1	-430 	6 	0	0	1	1	0	12.66	1	1.1	0.9;
% 13	1	41 	6 	0	0	1	1	0	12.66	1	1.1	0.9;
% 14	1	73 	14 	0	0	1	1	0	12.66	1	1.1	0.9;
% 15	1	49 	2 	0	0	1	1	0	12.66	1	1.1	0.9;
% 16	1	20 	3 	0	0	1	1	0	12.66	1	1.1	0.9;
% 17	1	47 	3 	0	0	1	1	0	12.66	1	1.1	0.9;
% 18	1	57 	7 	0	0	1	1	0	12.66	1	1.1	0.9;
% 19	1	42 	7 	0	0	1	1	0	12.66	1	1.1	0.9;
% 20	1	44 	7 	0	0	1	1	0	12.66	1	1.1	0.9;
% 21	1	45 	7 	0	0	1	1	0	12.66	1	1.1	0.9;
% 22	1	44 	7 	0	0	1	1	0	12.66	1	1.1	0.9;
% 23	1	45 	8 	0	0	1	1	0	12.66	1	1.1	0.9;
% 24	1	159 	34 	0	0	1	1	0	12.66	1	1.1	0.9;
% 25	1	179 	34 	0	0	1	1	0	12.66	1	1.1	0.9;
% 26	1	23 	4 	0	0	1	1	0	12.66	1	1.1	0.9;
% 27	1	36 	4 	0	0	1	1	0	12.66	1	1.1	0.9;
% 28	1	34 	3 	0	0	1	1	0	12.66	1	1.1	0.9;
% 29	1	66 	12 	0	0	1	1	0	12.66	1	1.1	0.9;
% 30	1	99 	102 	0	0	1	1	0	12.66	1	1.1	0.9;
% 31	1	80 	12 	0	0	1	1	0	12.66	1	1.1	0.9;
% 32	1	104 	17 	0	0	1	1	0	12.66	1	1.1	0.9;
% 33	1	44 	7 	0	0	1	1	0	12.66	1	1.1	0.9;
% 
% ];
...
%% 绝对绝对新加入的风光数据
%% 风机总出力
% 24列是因为24个时间段-风机容量可能为 1.5 MW
mpc.wind = [1.4 1.53 1.45 1.34 1.26 1.13 1.03 0.75 0.55 0.35 0.45 0.43 0.35 0.32 0.30 0.33 0.35 0.43 0.55 0.72 0.75 0.79 0.82 0.95];% 单位应该是MW
% plot(mpc.wind)
%% 光伏总出力
% 24列是因为24个时间段-光伏容量可能为 1 MW
mpc.pv = [0 0 0 0 0 0.185 0.195 0.3 0.48 0.63 0.7 0.76 0.83 0.76 0.7 0.63 0.48 0.3 0 0 0 0 0 0 ];       
% plot(mpc.pv)

%% 绝对绝对新导入的负荷数据
%% 负荷需求
% 24列是因为24个时间段
mpc.pload = [1.8 1.35 1.2 1.15 1.1 1.35 1.45 1.5 1.65 1.9 2.0 2.1 2.35 2.55 2.25 2.15 2.3 2.6 3.35 3.85 4.0 3.6 3.25 2.7];
%% 初始各节点有功负荷容量-如果更简单明晰后续可以和bus程序合一下
% 和为3715 + j2300 kVA-不过是在什么都不接情况下的节点功率罢了
mpc.pload_prim = [0;100;90;120;60;60;200;200;60;60;45;60;60;120;60;60;60;90;90;90;90;90;90;420;420;60;60;60;120;200;150;210;60];
mpc.qload_prim = [0;60;40;80;30;20;100;100;20;20;30;35;35;80;10;20;20;40;40;40;40;40;50;200;200;25;25;20;70;600;70;100;40];
