function[objective] = IEEE123down_position(x)
...
tic
%% BPSO综合情况 ob1 ob2 X
% idx = [80 98 118]; % IEEE123运行第一轮的最佳结果
% idx = [31 50 100]; % 5.2152+5.4436+6 =16.6588

% 20-20的运行情况
idx = [20 49 67];% 2.4678+6.4945+6=14.9623

[f1,r_load1,V_bias1,R_load1] = IEEE123function1(idx);
[f2,r_load2,V_bias2,R_load2] = IEEE123function2(idx);
[f3,r_load3,V_bias3,R_load3] = IEEE123function3(idx);
[f4,r_load4,V_bias4,R_load4] = IEEE123function4(idx);
[f5,r_load5,V_bias5,R_load5] = IEEE123function5(idx);
[f6,r_load6,V_bias6,R_load6] = IEEE123function6(idx);
[f7,r_load7,V_bias7,R_load7] = IEEE123function7(idx);
[f8,r_load8,V_bias8,R_load8] = IEEE123function8(idx);
[f9,r_load9,V_bias9,R_load9] = IEEE123function9(idx);
toc
...
X = 0.01*(0.1*Ees_cost*60); % 标幺值由10MVA变为1MVA
